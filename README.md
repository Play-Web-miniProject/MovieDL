...
　　[‘영화명']을 기준으로 movie_resize 데이터에 df2 데이터를 합침.    
...
#### 　　4) 결과 출력
　　각각의 변수를 받아 모델이 예측한 값이 5만 명 미만일 경우 회귀 모델을 적용하여 관객수를 출력하였으며, 5만 명 이상일 경우 분류 모델을 적용하여 결과를 출력하도록 함.   
  
#### 　　5) 배포
　　https://mysourcefile.github.io/
